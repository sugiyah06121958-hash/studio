  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        <AnalysisItem label="Kap Pasar" value={analysis.marketCap} />
        <AnalysisItem label="Rasio P/E" value={analysis.peRatio} />
        <AnalysisItem label="EPS" value={analysis.eps} />
        <AnalysisItem label="Hasil Dividen" value={analysis.dividendYield} />
        <AnalysisItem label="Utang thd Ekuitas" value={analysis.debtToEquity} />
      </CardContent>
    </Card>
  );
}
...
export function TechnicalAnalysisCard({ analysis }: AnalysisCardProps<TechnicalAnalysis>) {
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        <AnalysisItem label="MA 50 Hari" value={`$${analysis.movingAverage['50day'].toFixed(2)}`} />
        <AnalysisItem label="MA 200 Hari" value={`$${analysis.movingAverage['200day'].toFixed(2)}`} />
